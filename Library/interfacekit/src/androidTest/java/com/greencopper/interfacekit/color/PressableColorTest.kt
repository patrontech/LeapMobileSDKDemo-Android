...
internal class PressableColorTest {
    ...
    fun toColorStateListShouldReturnDefaultColor() {
        ...
        val result = pressableColor.toColorStateList()
        Assertions.assertThat(result.defaultColor)
            .isEqualTo(UIColor.default.background.primary.light)
    }

    class TestPressableColor(parent: UIColor) : PressableColor(parent) {
