...
Doesn't work well with margin/padding ItemDecorations
Source:
...
public class StickyHeaderDecoration(
    ...
    private fun getHeaderPositionForItem(itemPosition: Int): Int =
        (itemPosition downTo 0).find { isHeader(it) } ?: RecyclerView.NO_POSITION
}

public inline fun View.doOnEachNextLayout(crossinline action: (view: View) -> Unit) {
