...
internal class LocationsListV2InitializerTest {
    private val initializer = LocationsListV2Initializer()
    ...
    fun whenGettingLayout_withCorrectParams_shouldGetLayout() {
        ...
        val expectedParams = ListLayoutData(
            ...
            routeLinkKeyId = "locationId",
            analytics = ListLayoutData.Analytics(
                screenName = "screenName",
                screenClass = "locations_list",
                addToMyFavoritesEventName = "my_locations/add",
                removeFromMyFavoritesEventName = "my_locations/remove",
            ),
            emptyPage = EmptyPage(image = "image", title = "title", subtitle = "subtitle"),
            filtering = FilteringInfo(
                predicate = FilteringPredicate.Tag("tag")
            ...
            providerKey = "ListProvider.Locations",
            favoritesManagerKey = "MyLocations",
            redirectionHash = RedirectionHash(FeatureKey("Maps.LocationsList", 2), params.analytics.screenName)
        )
