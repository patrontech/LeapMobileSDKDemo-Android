...
internal class ActivitiesListV2InitializerTest {

    private val initializer = ActivitiesListV2Initializer()
    ...
    fun whenGettingLayout_withCorrectParams_shouldGetLayout() {
        ...
        val expectedParams = ListLayoutData(
            ...
            routeLinkKeyId = "activityId",
            analytics = ListLayoutData.Analytics(
                screenName = "screenName",
                screenClass = "activities_list",
                addToMyFavoritesEventName = "my_activities/add",
                removeFromMyFavoritesEventName = "my_activities/remove",
            ),
            emptyPage = EmptyPage(image = "image", title = "title", subtitle = "subtitle"),
            filtering = FilteringInfo(
                predicate = FilteringPredicate.Tag("tag")
            ...
            providerKey = "ListProvider.Activities",
            favoritesManagerKey = "MyActivities",
            redirectionHash = RedirectionHash(FeatureKey("Event.ActivitiesList", 2), params.analytics.screenName)
        )
