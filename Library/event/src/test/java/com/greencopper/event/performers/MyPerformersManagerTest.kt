...
internal class MyPerformersManagerTest {
    private lateinit var classUnderTest: MyPerformersManager
    ...
    fun setUp() {
        ...
        classUnderTest = MyPerformersManager(
    ...
    fun addToFavoritesShouldAddTwo() {
        classUnderTest.addToFavorites(Performer("1"))
        classUnderTest.addToFavorites(Performer("2"))
    ...
    fun removeFromFavoritesShouldRemoveZero() {
        classUnderTest.removeFromFavorites(Performer("1"))
    ...
    fun removeFromFavoritesShouldRemoveTwo() {
        lazyLocalStorage.resolve().project.event.myPerformers.value = setOf("1", "2", "3")
        ...
        classUnderTest.removeFromFavorites(Performer("4"))
        assertThat(classUnderTest.favoriteIds).hasSize(2)
        runTest {
            assertThat(classUnderTest.favoriteIdsFlow.first()).hasSize(2)
        }
    ...
    data class Performer(override val itemId: String) : Favoriteable<String>
}
