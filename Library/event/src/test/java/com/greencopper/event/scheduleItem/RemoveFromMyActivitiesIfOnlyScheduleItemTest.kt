...
internal class RemoveFromMyActivitiesIfOnlyScheduleItemTest :
    ...
    private lateinit var classUnderTest: RemoveFromMyActivitiesIfOnlyScheduleItem
    ...
    @Test
    @DisplayName("When removing scheduleItem of single item Activity to favorites, then Activity should be unfavorited")
    fun automationShouldRemoveFromFavoriteIfSingle() = runTest {
        ...
        classUnderTest = RemoveFromMyActivitiesIfOnlyScheduleItem(
        ...
        myScheduleManager.removeFromFavorites(MockFavoriteable(schedule1Id))
        delay(500)

        myActivitiesManager.addToFavoritesCallCount shouldBe 0
        myActivitiesManager.removeFromFavoritesCallCount shouldBe 1
        myActivitiesManager.favoriteIds shouldBe setOf()
    }

    @Test
    @DisplayName("When removing scheduleItem of multiple items Activity to favorites, then nothing should happen")
